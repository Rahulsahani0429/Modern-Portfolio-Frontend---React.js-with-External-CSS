                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-left">
                        ...
                        <p className="footer-contact-info">
                            ...
                            <a href="mailto:rahulsahani33438@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }} className="footer-email-link">rahulsahani33438@gmail.com</a>
                        </p>
                    ...
                    <div className="footer-right">
                        ...
                        <div className="footer-socials">
                            ...
                            <a href="mailto:rahulsahani33438@gmail.com"><FaEnvelope /></a>
                        </div>
                    </div>
                </div>
            </div>
